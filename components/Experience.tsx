  ...
  const experiences = [
    {
      ...
      achievements: [
        'Built multivendor e-commerce platform using Medusa.js and Mercurius backend with Next.js frontend',
        'Developed responsive and scalable UIs using Next.js 15+, React 18+, and TypeScript',
        'Created reusable component libraries with React Hooks and Context API',
        ...
        'Quickly adapted to new technologies including Medusa.js ecosystem and open-source tools',
        'Collaborated with designers and backend teams using Agile methodologies',
      ],
      technologies: ['Next.js', 'React', 'TypeScript', 'Medusa.js', 'Mercurius', 'JavaScript', 'HTML', 'CSS', 'Tailwind', 'REST APIs', 'Git'],
    },
    {
